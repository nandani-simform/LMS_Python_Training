...
def student_detail_list(request, format=None):
...
class StudentAPI(View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        pythondata =  JSONParser().parse(stream) ##deserialising json data into pyhton data
        ...
        stu = Students.objects.all()
        serializer = StudentSerializers(stu, many=True)
        json_data = JSONRenderer().render(serializer.data) #serialising data into json format
        return HttpResponse(json_data, content_type = 'application/json')
